package com.example.scancard.e2e
...
// import com.example.scancard.MainActivity
...
//    (app/build.gradle.kts:21 testInstrumentationRunner = "com.example.scancard.HiltTestRunner")
// 3. Hilt TestModule で FakeDocumentScanner / FakeGemmaExtractor / inMemory DB を提供
//    （本番の MLKit / Room を使わず、Fakeで高速・安定化）
// 4. エミュレータ/実機で実行:
//    ./gradlew :app:connectedDebugAndroidTest --tests "com.example.scancard.e2e.ScanToStudyE2ETest"
//    または特定シナリオのみ:
